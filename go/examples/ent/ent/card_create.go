...
func (cc *CardCreate) SetAmount(f float64) *CardCreate {
	cc.mutation.SetAmount(f)
	return cc
}

// SetCardID sets the cardID field.
func (cc *CardCreate) SetCardID(si schema.CardID) *CardCreate {
	cc.mutation.SetCardID(si)
	return cc
}
...
func (cc *CardCreate) check() error {
	...
	if _, ok := cc.mutation.CardID(); !ok {
		return &ValidationError{Name: "cardID", err: errors.New("ent: missing required field \"cardID\"")}
	}
	return nil
}
