...
func (pu *PetUpdate) SetStatus(i int) *PetUpdate {
...
func (pu *PetUpdate) SetNillableStatus(i *int) *PetUpdate {
	if i != nil {
		pu.SetStatus(*i)
	}
	return pu
...
func (pu *PetUpdate) AddStatus(i int) *PetUpdate {
...
// SetStatus sets the status field.
func (puo *PetUpdateOne) SetStatus(i int) *PetUpdateOne {
...
// SetNillableStatus sets the status field if the given value is not nil.
func (puo *PetUpdateOne) SetNillableStatus(i *int) *PetUpdateOne {
	if i != nil {
		puo.SetStatus(*i)
	}
	return puo
...
// AddStatus adds i to status.
func (puo *PetUpdateOne) AddStatus(i int) *PetUpdateOne {
