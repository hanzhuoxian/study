...
func (ctrl *UsersController) Index(c *gin.Context) {
	...
	if ok, _ := requests.Validate(c, &request, requests.Pagination); !ok {
		return
	}
...
func (ctrl *UsersController) Store(c *gin.Context) {
	...
	if ok, errs := requests.Validate(c, &request, requests.UserSave); !ok || len(errs) > 0 {
		return
	}
...
func (ctrl *UsersController) UpdateProfile(c *gin.Context) {
	...
	if ok, _ := requests.Validate(c, &request, requests.UserUpdateProfile); !ok {
		return
	}
...
func (ctrl *UsersController) UpdateEmail(c *gin.Context) {
	...
	if ok, _ := requests.Validate(c, &request, requests.UserUpdateEmail); !ok {
		return
	}
...
func (ctrl *UsersController) UpdatePhone(c *gin.Context) {
	...
	if ok, _ := requests.Validate(c, &request, requests.UserUpdatePhone); !ok {
		return
	}
...
func (ctrl *UsersController) UpdatePassword(c *gin.Context) {
	...
	if ok, _ := requests.Validate(c, &request, requests.UserUpdatePassword); !ok {
		return
	}
...
func (ctrl *UsersController) UpdateAvatar(c *gin.Context) {
	...
	if ok, _ := requests.Validate(c, &request, requests.UserUpdateAvatar); !ok {
		return
	}
